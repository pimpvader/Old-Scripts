...
if  [ ${displayType,,} = laptop ]
	then rdesktop -T $target -u jrohde -d CORP -p Ja5M1n31214 -g 95% $target'.corp.valueclick.com'
elif [ ${displayType^^} = TV ]
        then rdesktop -T $target -u jrohde -d CORP -p Ja5M1n31214 -g 50% $target'.corp.valueclick.com'
elif [ ${displayType,,} = dock ]
	then rdesktop -T $target -u jrohde -d CORP -p Ja5M1n31214 -g 1920x1000 $target'.corp.valueclick.com'
